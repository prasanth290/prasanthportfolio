...
export function SiteSettingsForm({ initialSettings }: { initialSettings: Record<string, string> }) {
  const [settings, setSettings] = useState({
    contact_email: initialSettings.contact_email || "prasanth@customwebstudio.com",
    contact_phone: initialSettings.contact_phone || "+1 (555) 019-2831",
    contact_whatsapp: initialSettings.contact_whatsapp || "+15550192831",
    ...
    ga4_id: initialSettings.ga4_id || "G-DEVSTUDIO2026",
    meta_pixel_id: initialSettings.meta_pixel_id || "PIXEL-987654321",
  });
